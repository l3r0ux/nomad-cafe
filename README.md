...
I wrote everything from scratch with vanilla html, css and javascript on the front end, and I also made/edited all of the images for the site with Photoshop. The API I wrote with Node.js is RESTful and has full CRUD functionality. I also followed the MVC architecture for the routes.
